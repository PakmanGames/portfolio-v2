        ...
        <footer className="flex flex-col bg-theme-not-white z-[1] border-t border-border/50 px-4 py-16 justify-evenly items-center text-center text-sm md:text-md mt-32">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-16 w-full max-w-6xl">
                ...
                <div className="flex flex-col items-start md:items-start gap-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-left max-w-xs leading-relaxed">
                ...
                <div className="flex flex-col items-start gap-2">
                    ...
                    <a href="https://www.linkedin.com/in/andy-pak/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-blue-700 transition-colors">
                ...
                <div className="flex flex-col items-start gap-2">
                    ...
                    <a href="https://github.com/pakmangames" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-black dark:hover:text-white transition-colors">
                        <Github size={18} className="text-black dark:text-white" /> GitHub
                    </a>
                    <a href="https://leetcode.com/u/pakmangames/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-orange-500 transition-colors">
                ...
                <div className="flex flex-col items-start gap-2">
                    ...
                    <a href="https://devpost.com/PakmanGames" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-blue-500 transition-colors">
                        <BookOpen size={18} className="text-blue-500" /> Devpost
                    </a>
                    <a href="https://dorahacks.io/hacker/PakmanGames" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
