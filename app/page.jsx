  ...
  return (
    <div className="flex flex-grow justify-center items-center">
      <div className="flex justify-center items-center flex-wrap border-solid rounded-2xl border-8 border-blue-900 p-11 gap-10 m-10">
        <div>
          <Image src={gradPhoto} alt="Picture of Andy Pak" className="w-60 h-auto border-solid rounded-2xl border-8 border-black"></Image>
        </div>
        <div className="text-center flex flex-col gap-11 items-center justify-center">
          <div className="text-7xl">Andy Pak</div>
          <div className="text-xl">Software Engineer at McMaster University</div>
